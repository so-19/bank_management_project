...
while(True):
    ...
    print("1=Create account")#Sharvil
    print("2=Deposit money")#Sharvil
    print("3=Withdraw money")#Sharvil
    print("4=Display account")#Sharvil
    print("5=Transfer Money")#Sharvil
    print("Loan")#Sharvil
    print("6=Exit")#Sharvil  #Integrating the program- Sharvil
